...
import { deleteSupplier, type Supplier } from "@/app/(authenticated)/estoque/actions";
...
export function SupplierActions({ supplier, onEdit, onDeleted }: SupplierActionsProps) {
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            &quot;{supplier.name}&quot; será arquivado
                                        </p>
                                    </div>
                                </div>
                                <p className="text-sm text-muted-foreground mb-6">
                                    O fornecedor não aparecerá mais nas listas. Esta ação pode ser revertida pelo administrador.
                                </p>
